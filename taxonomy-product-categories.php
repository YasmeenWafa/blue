...
<div class="products-page-container">
	...
	<ul class="tabs product-categories-tabs" data-tabs id="product-categories-tabs"   data-deep-link="true" data-update-history="true"  data-deep-link-smudge="true" data-deep-link-smudge-delay="600" data-auto-focus="false">
		...
		foreach($terms as $term):?>
			...
			<li style = "background-image: url(<?php echo $cat_image; ?>)"  class="tabs-title <?php if($current_term->name === $term->name ){ echo 'is-active'; }?>">
	...
	<div class="tabs-content product-categories-tabs-content" data-tabs-content="product-categories-tabs">
		<?php $catIndex = 0;
		foreach($terms as $term):?>
			<div class="tabs-panel <?php if($current_term->name === $term->name ){ echo 'is-active'; }?> " id="cat<?php echo $catIndex; ?>">
			<?php
			...
			<h2 class="title page-subtitle animatedText"><span><?php echo $term->name;?></span></h2>
				...
				<?php $productIndex = 0; ?>
					...
					<div class="tabs-panel <?php if ($productIndex == 0) { echo 'is-active'; }?>" id="cat<?php echo $catIndex;?>product<?php echo $productIndex;?>">
						...
						style="background-image: url(<?php //echo wp_get_attachment_url( get_post_thumbnail_id($product->ID), 'thumbnail' ); ?>);">
							<div class="overlay"></div>
